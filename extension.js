...
let greetings = {
  "greets": [
    "Hi Coder!", "Hi Programmer!", "Hi Geek!", "Hi Techie!", "Hi Coder!",
    "Hello Coder!", "Hello Programmer!", "Hello Geek!", "Hello Techie!",
    "Hello Coder!"
  ],
  "wishes": [
    "Have a great day ahead.", "Have an awesome coding day.",
    "Happy programming.", "Have a great day."
  ]
};
  ...
  function greet() {
    ...
    dns.resolve('www.google.com', function (err) {
      if (err) {
        ...
        vscode.window.setStatusBarMessage(content, 25000);
      } else {
